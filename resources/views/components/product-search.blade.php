        ...
        <div class="p-1">
            ...
            <template x-if="results.length === 0 && !loading">
                <div class="p-8 text-center">
                    <div class="text-xs font-bold opacity-30 uppercase tracking-widest mb-1">No results found</div>
                    <div class="text-[11px] opacity-50">Try searching for something else</div>
                </div>
            </template>
        </div>
    </div>
