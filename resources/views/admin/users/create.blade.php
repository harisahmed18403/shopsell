<x-app-layout>
    <div class="mb-4">
        <h1 class="text-lg font-bold uppercase tracking-wider opacity-70">Create New User</h1>
    </div>
            ...
            <form method="POST" action="{{ route('admin.users.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <select id="role" name="role" class="select select-bordered select-sm w-full mt-1 rounded-sm">
                        ...
                        <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Admin (Branch Manager)</option>
